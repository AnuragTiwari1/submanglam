...
export const PersonDetailsModel = types
  .model("PersonDetails", {
    ...
    photo: types.optional(types.string, "profile.png"),
    photo2: types.optional(types.string, "profile.png"),
    photo3: types.optional(types.string, "profile.png"),
    photo4: types.optional(types.string, "profile.png"),
    photo5: types.optional(types.string, "profile.png"),
  })
  .props({})
